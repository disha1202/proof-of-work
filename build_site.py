...
BENTO_CSS = """
    ...
    .bento { display: grid; grid-template-columns: repeat(4, 1fr); grid-auto-rows: 38px; grid-auto-flow: row dense; gap: 14px; margin-bottom: 30px; }
    ...
    .tile-avatar { grid-column: span 2; grid-row: span 7; padding: 0; display: block; }
    ...
    .tile-head { grid-column: span 2; grid-row: span 5; display: flex; flex-direction: column; justify-content: center; gap: 5px; }
    ...
    .tile-lang { grid-column: span 2; grid-row: span 4; display: flex; flex-direction: column; gap: 14px; justify-content: center; }
    ...
    .tile-social { grid-column: span 1; grid-row: span 4; display: flex; flex-direction: column; justify-content: space-between; text-decoration: none; color: var(--ink); cursor: pointer; transition: transform 0.12s, border-color 0.15s, color 0.15s; }
    .sc-linkedin, .sc-twitter { grid-row: span 3; }
    ...
    .num { grid-column: span 1; grid-row: span 3; display: flex; flex-direction: column; justify-content: center; gap: 4px; }
    .n-prs, .n-orgs, .n-following, .n-stars { grid-row: span 4; }
